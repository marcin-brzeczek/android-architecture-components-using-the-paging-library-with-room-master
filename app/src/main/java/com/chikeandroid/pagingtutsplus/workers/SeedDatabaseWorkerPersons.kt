...
import com.chikeandroid.pagingtutsplus.utils.NAME_PERSON_DATA_FILENAME
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.google.gson.stream.JsonReader

class SeedDatabaseWorkerPersons : Worker() {

    private val TAG = SeedDatabaseWorkerPersons::class.java.simpleName
    ...
    override fun doWork(): Worker.Result {
        ...
        return try {
            val inputStream = getApplicationContext().assets.open(NAME_PERSON_DATA_FILENAME)
